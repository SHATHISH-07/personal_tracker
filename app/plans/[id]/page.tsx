...
export default function PlanDetailPage() {
  ...
  if (!plan) {
    return (
      <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-8 py-12 text-center font-sans space-y-4">
        ...
        <button
          ...
          className="px-5 py-2.5 rounded-xl bg-[#272727] text-white font-extrabold text-xs inline-flex items-center gap-2 cursor-pointer shadow-xs"
        >
  ...
  return (
    <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-8 space-y-6 pb-16 font-sans animate-in fade-in duration-300">
      {/* Top Navigation & Actions Bar */}
      <div className="bg-white border border-[#e4e4e7] px-6 py-4 rounded-xl shadow-2xs flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div className="flex flex-wrap items-center gap-4">
          <button
            onClick={() => router.push("/plans")}
            className="p-2.5 rounded-xl bg-[#f4f4f5] border border-[#e4e4e7] hover:bg-[#272727] hover:text-white text-black transition-all cursor-pointer shadow-2xs flex items-center justify-center"
          ...
          <div>
            <div className="flex items-center gap-2.5 flex-wrap">
              ...
              <span
                className={`text-xs font-extrabold uppercase px-2.5 py-0.5 rounded-md border shadow-2xs ${
        ...
        <div className="flex flex-wrap items-center gap-2.5 self-start lg:self-auto">
          <button
            ...
            className={`px-4 py-2.5 rounded-xl text-xs font-extrabold flex items-center gap-1.5 border transition-all cursor-pointer shadow-2xs ${
              plan.status === "completed"
          ...
          {plan.status === "completed" && (
            <button
              ...
              className="px-4 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-extrabold text-xs flex items-center gap-1.5 shadow-2xs transition-all cursor-pointer"
          ...
          <button
            ...
            className="p-2.5 rounded-xl bg-red-50 hover:bg-red-100 border border-red-200 text-red-600 transition-colors cursor-pointer shrink-0 shadow-2xs"
      ...
      <Card className="p-6 sm:p-8 bg-white border-[#e4e4e7] shadow-2xs rounded-2xl space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#e4e4e7] pb-4">
          <div>
            <h2 className="text-2xl font-black text-black">Edit Roadmap</h2>
          </div>

          <button
            onClick={() => setIsEditingInfo(!isEditingInfo)}
            className={`px-4 py-2 rounded-xl text-xs font-extrabold flex items-center gap-1.5 border transition-all cursor-pointer shadow-2xs self-start sm:self-auto ${
              isEditingInfo
        ...
        {isEditingInfo ? (
          <form
            ...
            className="space-y-4 bg-[#f4f4f5] p-6 rounded-xl border border-[#e4e4e7]"
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <Select
                  ...
                  className="bg-white border-[#e4e4e7] text-black font-bold h-10"
                >
            ...
            <div className="space-y-1.5">
              ...
              <Textarea
                ...
                rows={4}
                className="bg-white border-[#e4e4e7] text-black text-sm"
              />
            </div>
            <div className="flex justify-end gap-2 pt-2">
              <button
                ...
                className="px-4 py-2 rounded-lg bg-white border border-[#e4e4e7] hover:bg-[#e4e4e7] text-black font-bold text-xs cursor-pointer"
              >
                Cancel
              </button>
              <button
                ...
                className="px-6 py-2 rounded-lg bg-[#272727] hover:bg-[#27272a] text-white font-bold text-xs cursor-pointer disabled:opacity-50"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="sm:col-span-2 space-y-4">
              <div>
                ...
                <p className="text-base font-bold text-black">{plan.title}</p>
              </div>
              <div>
                <h3 className="text-xs font-black uppercase tracking-wider text-[#71717a] mb-1">
                  Description & Objectives
                </h3>
                <div className="text-sm font-medium text-[#27272a] leading-relaxed bg-[#fafafa] p-4 rounded-xl border border-[#f4f4f5] whitespace-pre-wrap">
                  {plan.description ||
      ...
      <Card className="p-6 sm:p-8 bg-white border-[#e4e4e7] shadow-2xs rounded-2xl space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#e4e4e7] pb-4">
          ...
          <div className="flex items-center gap-4 self-start sm:self-auto">
            ...
            <button
              ...
              className="px-4 py-2.5 rounded-xl bg-[#272727] text-white font-extrabold text-xs flex items-center gap-2 shadow-xs transition-all cursor-pointer"
            >
        ...
        {isAddingTopic && (
          <form
            ...
            className="bg-[#f4f4f5] p-6 rounded-xl border border-[#e4e4e7] space-y-4 animate-in fade-in duration-200"
          >
            <div className="flex items-center justify-between border-b border-[#e4e4e7] pb-2">
              ...
              <button
                ...
                className="text-xs font-bold text-[#71717a] hover:text-black cursor-pointer"
              >
                ✕ Close
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="md:col-span-3">
                ...
                <Input
                  ...
                  required
                  className="bg-white border-[#e4e4e7] text-black text-sm h-10 font-bold"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <Textarea
                ...
                rows={2}
                className="bg-white border-[#e4e4e7] text-black text-sm p-3 rounded-lg"
              />
            </div>
            ...
            <div className="flex justify-end">
              <button
                ...
                className="px-6 py-2.5 rounded-lg bg-[#272727] hover:bg-[#27272a] text-white text-xs font-bold flex items-center justify-center gap-2 cursor-pointer shadow-xs transition-all h-10 disabled:opacity-50"
              >
                <Plus className="w-4 h-4" />
          ...
          {totalTopics === 0 ? (
            <div className="py-12 text-center bg-[#fafafa] rounded-xl border border-dashed border-[#e4e4e7] text-[#71717a]">
              ...
              <button
                ...
                className="px-4 py-2 rounded-lg bg-[#272727] text-white text-xs font-bold inline-flex items-center gap-1.5 cursor-pointer"
              >
                        ...
                        >
                          <div className="flex items-start gap-3.5 flex-1 min-w-0">
                            <div className="flex-1 min-w-0">
                              <span
                                className={`font-extrabold text-base block ${topic.completed ? "line-through text-[#71717a]" : "text-black"}`}
                              >
                                {topic.name}
                              </span>
                              {topic.description && (
                                <div className="mt-2 text-sm font-normal text-[#27272a] bg-[#fafafa] p-3 rounded-lg border border-[#f4f4f5] leading-relaxed whitespace-pre-wrap">
                                  {topic.description}
                                </div>
                              )}
                            </div>
