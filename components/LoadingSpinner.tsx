...
export default function LoadingSpinner({
  ...
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center bg-[#f4f4f5]/50 z-10 px-4 gap-4 sm:gap-5 text-center select-none backdrop-blur-[1px]">
