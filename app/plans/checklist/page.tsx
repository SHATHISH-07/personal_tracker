    ...
    <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-8 space-y-4 pb-12 font-sans">
      <div className="w-full max-w-none space-y-8 animate-in fade-in duration-300">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between w-full gap-4">
            ...
            <div className="flex flex-wrap items-center gap-3 self-start sm:self-auto">
              ...
              <div className="flex items-center gap-2 bg-[#f4f4f5] px-3 py-1.5 rounded-xl border border-[#e4e4e7]">
                <span className="text-xs font-extrabold text-black">Plan:</span>
                <select
                  ...
                  className="bg-transparent text-sm font-bold text-black focus:outline-none cursor-pointer max-w-[250px] truncate"
                >
                  {plans.length === 0 ? (
        ...
        {!selectedPlan ? (
          ...
          <Card className="p-12 text-center border border-dashed border-[#d4d4d8] bg-white shadow-2xs rounded-2xl">
            ...
            <button
              ...
              className="px-4 py-2 rounded-md bg-black text-white font-semibold text-xs inline-flex items-center gap-2 shadow-xs hover:bg-[#27272a] cursor-pointer"
            >
              Go to Roadmap
            </button>
          </Card>
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex items-center gap-6 self-start sm:self-auto shrink-0">
                      ...
                      <div
                        className={`p-2 rounded-full transition-colors ${isExpanded ? "bg-[#272727] text-white" : "bg-[#f4f4f5] text-black group-hover:bg-[#e4e4e7]"}`}
                      >
                        {isExpanded ? (
                  ...
                  {isExpanded && (
                    <div className="p-5 sm:p-6 bg-[#fafafa] border-t border-[#e4e4e7] animate-in slide-in-from-top-2 duration-200">
                      {topic.description && (
                      ...
                      <div className="space-y-4">
                        ...
                        >
                          <Input
                            ...
                            className="flex-1 bg-white border-[#e4e4e7] focus:border-black font-bold text-sm h-12 rounded-xl"
                          />
                          <button
                            type="submit"
                            disabled={!(newItemTitles[topicIdx] || "").trim()}
                            className="px-6 h-12 rounded-xl bg-[#272727] hover:bg-[#27272a] disabled:opacity-40 text-white font-extrabold text-sm flex items-center gap-2 shrink-0 shadow-sm transition-all cursor-pointer"
                          >
                        ...
                        {checklistItems.length === 0 ? (
                          <div className="p-8 text-center border border-dashed border-[#d4d4d8] rounded-xl bg-white">
